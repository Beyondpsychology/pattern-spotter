      ...
      <section className="ps2-section" style={{ background: "var(--terracotta-bright)", color: "#fff" }} id="tool">
        <div className="ps2-container">
          ...
          <div className="ps2-price-box">
            ...
            <p className="ps2-cta-subtext" style={{ color: "rgba(255,255,255,0.85)" }}>€27 for 5 readings. Instant access, no account needed. Five questions, five sections back. Built by a psychologist. Sent to your inbox as a PDF.</p>
          </div>
        </div>
      </section>
