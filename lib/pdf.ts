...
export async function generateReadingPdf(reading: ReadingResultData): Promise<Buffer> {
  ...
  return new Promise((resolve, reject) => {
    ...
    const aboutParagraphs = [
      ...
      "For as long as it has existed, psychology has treated you as something to be fixed. The anxiety, the need for control, the exhaustion, the pleasing, the depression, gathered into symptoms and handed back as proof that something about you was wrong.",
      "We see it differently. You were not born this way. What you were taught to see as a personal failing is most often an intelligent response to a world that asked you to perform, adapt, suppress your aliveness and authenticity, and make yourself smaller to belong, until the shame of being who you are became the water you swim in.",
      "What you carry is not a personal failing. It is what happens to you when you have to abandon yourself to belong.",
    ...
    doc
      ...
      .fontSize(8.5)
      .text(
        "Myrthe Glasbergen, MSc. is a psychologist and the founder of Beyond Psychology. She has an unusual talent for seeing where people are stuck: which patterns are holding them back, and which relational wounds from the past are still present in the body, in daily choices, in relationships. She built the Pattern Spotter so that same way of seeing could travel further than the room she is in. Reading this is the same as sitting across from her.",
        textX,
        doc.y + 8,
